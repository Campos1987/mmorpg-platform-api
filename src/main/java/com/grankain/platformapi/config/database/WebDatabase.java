...
@EnableJpaRepositories(basePackages = "com.grankain.platformapi.auth.repository", entityManagerFactoryRef = "webEntityManagerFactory", transactionManagerRef = "webTransactionManager")
